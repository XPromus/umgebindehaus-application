...
namespace TMPro.Examples
{
    ...
    public class TMP_TextSelector_B : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IPointerClickHandler, IPointerUpHandler
    {
        ...
        void RestoreCachedVertexAttributes(int index)
        {
            ...
            // Restore UV0S
            // UVS0
            Vector2[] src_uv0s = ConvertToVectorArray(m_cachedMeshInfoVertexData[materialIndex].uvs0);
            Vector2[] dst_uv0s = ConvertToVectorArray(m_TextMeshPro.textInfo.meshInfo[materialIndex].uvs0);
            ...
            // UVS0
            src_uv0s = ConvertToVectorArray(m_cachedMeshInfoVertexData[materialIndex].uvs0);
            dst_uv0s = ConvertToVectorArray(m_TextMeshPro.textInfo.meshInfo[materialIndex].uvs0);
        ...
        private static Vector2[] ConvertToVectorArray(Vector4[] vectors)
        {
            return vectors.Select(vector => (Vector2)vector).ToArray();
        }
